...
function submitForgotUsernameInfo(currentPhase) {
	...
	xhr.open('POST','/submitForgotUsernameInfo', false);
	...
	xhr.onreadystatechange = function() {
		if(xhr.readyState === 4) 
		{
			if(xhr.status === 200)
			{
				document.location = "/workDone/username";
			}
